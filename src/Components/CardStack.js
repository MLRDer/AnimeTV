    ...
    renderLastView() {
        ...
        if (this.props.data.length > 2) {
            return (
                <Animated.View
                    key={JSON.stringify(
                        this.dataArray[this.getLastViewIndex()]
                    )}
                    style={{
                        zIndex: 1,
    ...
    renderSwipeableViews() {
        ...
        return (
            ...
            >
                ...
                >
                    {this.props.renderItem(
                        this.dataArray[this.getLastDummyViewIndex()]
                    )}
                </Animated.View>
                ...
                <Animated.View
                    ...
                    onResponderStart={this.props.onSwipeStart}
                    onResponderEnd={this.props.onSwipeEnd}
                    style={[
                        {
                            zIndex: this.state.viewStackedAnim.interpolate({
                                inputRange: [0, 0.5, 1],
